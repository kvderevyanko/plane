...
The P60B 6S1P integration envelope is **155 x 75 x 28 mm**, a feasible two-cells-long by three-cells-wide 21700 arrangement including interconnect, insulation, connector exit and modest assembly allowance; it is not a verified pack drawing. The current unified ledger needs an indexed **50-mm** rail, X=-382.5...-332.5, to close 24/25/26/28% MAC at required pack centres -381.39/-369.99/-358.58/-335.77 mm respectively. Nominal first-flight reservation is **X=-370.0**, which yields 25.00% MAC in the central wheel ledger. The complete moving pack envelope is X=-460...-255. This replaces obsolete X=0, X=-330 and earlier ledger iterations. Final measured-CG release is still mandatory.
