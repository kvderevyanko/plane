...
Intermediate shape formers are 2-mm birch. The **two lower 5x3-mm pultruded-carbon longerons** run continuously from X=-475 to +365, tying the forward battery-stop/keel box into the wing box; the upper pair runs X=-170 to +410. 2-mm birch side rails and the hatch perimeter are primary tension/shear members around the battery opening. Thus no battery stop discharges into unsupported shell. Exact supplier data, scarf detail and adhesive overlap remain coupon/CAD gates. Sand laser-charred structural bond faces to sound wood, abrade and de-dust. Nominal CAD contains no kerf compensation; a measured-kerf coupon controls finished slots.
...
The P60B 6S1P integration envelope is **155 x 75 x 28 mm**, a feasible two-cells-long by three-cells-wide 21700 arrangement including interconnect, insulation, connector exit and modest assembly allowance; it is not a verified pack drawing. The prototype rail has **55-mm** useful travel, X=-387.5...-332.5, extending the prior forward limit by 5 mm without lengthening the nose. With the fixed-nose gear ledger, required pack centres are -384.78/-373.40/-362.03/-339.27 mm for 24/25/26/28% MAC respectively. The X=-370.0 nominal reference yields 25.30% MAC; exact 24% and 25% are physically reachable. The complete moving pack envelope is X=-465...-255. Final measured-CG release is mandatory.

Use a top hatch with a provisional **230 x 125-mm clear opening** (approximately X=-472.5...-242.5), two mechanical latches and a secondary retained strap. Its CAD removal sweep clears the pack at both rail limits, but physical dummy-pack service proof remains required. No full-width former crosses this opening: the -285/-170 stations are lower-keel partial U-webs only, while the birch perimeter/side rails close the load path. The pack lifts up after guarded disconnect; it does not pass servo horns/high-current wire. Full-area non-compressive cradle, 3-mm stops and two 20-mm straps take the 6-g retention assumption with 1.5 proof: a 503-g pack needs **29.6 N operational / 44.4 N proof per principal direction**. Treat each complete stop/strap path as capable of the full proof load rather than claiming a failed path shares it. At nominal X=-370.0 the battery CG ledger moment is **-186,110 g mm**. Proof with an inert dummy in six directions.
